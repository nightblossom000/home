...
<form method="POST"  onSubmit={search}>
    <div className="relative text-gray-600 focus-within:text-gray-400">
      ...
      <input type="search" name="q" className="py-2 text-sm border-2 dark:border-b-slate-700 dark:bg-white bg-background rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Search..." autoComplete="off" />
    </div>
  </form>
